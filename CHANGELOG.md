...
- Optimized monitor WMI/CIM retrieval in [internal\MonitorEdidResolver.psm1](file:///d:/Users/joty79/scripts/DeviceCheck/internal/MonitorEdidResolver.psm1) by querying classes in bulk once and caching them in module scope (`$script:GlobalWmiMonitorIDs`, etc.), caching hardware ID breakdown lines in `$script:HardwareIdBreakdownCache` in [04-UiTextFormatting.ps1](file:///d:/Users/joty79/scripts/DeviceCheck/internal/DeviceCheck/04-UiTextFormatting.ps1), clearing all query/resolver caches during rescan/cache invalidation in [03-EvidenceResolvers.ps1](file:///d:/Users/joty79/scripts/DeviceCheck/internal/DeviceCheck/03-EvidenceResolvers.ps1), and adding immediate remote target bypasses, reducing TUI device selection render latency under 50ms.
