...
| `internal\MonitorEdidResolver.psm1` | Decodes raw monitor EDID bytes and reads local registry EDID evidence for present DISPLAY devices. |
| `internal\Test-MonitorEdidResolver.ps1` | Smoke-tests EDID manufacturer/product/name/date/checksum decoding with a synthetic valid fixture. |
