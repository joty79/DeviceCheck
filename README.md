...
| `internal\HardwareIdResolver.psm1` | Parses and resolves PCI/USB/HID/HDAUDIO/SCSI/ACPI/PNP IDs from the local cache. |
| `internal\Test-HardwareIdResolver.ps1` | Smoke-tests resolver behavior for USB `VID/PID/REV/MI`, generic USB class compatible IDs, SCSI storage IDs, and HDAUDIO codec/subsystem IDs. |
